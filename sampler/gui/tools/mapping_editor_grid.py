...
class MappingOverlay(Gtk.DrawingArea):
	...
	def on_drawing_area_draw(self, drawing_area, cc):
		...
		note = self.note+1
		cc.move_to(math.floor(note * self.cell_width + self.cell_width/2), self.cell_height * (self.grid_height - 5))
		cc.line_to(math.floor(note * self.cell_width + self.cell_width/2), self.cell_height * (self.grid_height - 4))
		cc.stroke()
